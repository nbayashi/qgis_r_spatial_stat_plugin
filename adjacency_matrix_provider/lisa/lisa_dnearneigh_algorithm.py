...
class LISADnearneighAlgorithm(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'lisadnearneigh'
    
    def icon(self):
        return QIcon(os.path.join(os.path.dirname(__file__), 'icon_lisa_dnearneigh.png'))


    def displayName(self):
        return self.tr('LISA(Distance-based Nearest Neighbor)')
    ...
    def createInstance(self):
        return LISADnearneighAlgorithm()
